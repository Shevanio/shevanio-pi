...
try {
	...
	const activePiOwnedFiles = ["extensions/gentle-ai.ts", "lib/sdd-preflight.ts", "extensions/skill-registry.ts"];
	const stalePiOwnedPhrases = ["el Gentleman", "Gentle AI safety policy", "Gentle AI SDD preflight complete", "Skip the Gentle AI skill registry", "Auto-generated by gentle-pi"];
